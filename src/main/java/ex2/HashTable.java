...
public class HashTable {
    ...
    public void put(String key, String value) {
        ...
        if (entries[hash] == null) {
            ...
            //Pongo que si un valor es igual a uno que ya hay lo reemplazo
        ...
        //Añado un item para que el contador me pueda sumar
        ITEMS++;
    }
    ...
    public String get(String key) {
        ...
        if (entries[hash] != null) {
            ...
            // Si no encuentra nada te da null y sino error
            temp = Buscador(key, temp);
    ...
    private HashEntry Buscador(String key, HashEntry temp) {
    ...
    public void drop(String key) {
        ...
        if(entries[hash] != null) {
            ...
            temp = Buscador(key, temp);
            //Borra el primer elemento de una linea
            if (temp.prev == null) {
                    if (temp.next != null)
                        temp.next.prev = null;
